...
#import "MainFactController.h"
#import <iAd/iAd.h>

@interface MainFactController ()

@end

@implementation MainFactController
...
- (IBAction)TapMe:(id)sender {
    ...
    if (factNumber == 1) {
        ...
        tapToContinue.text = @"Tap to continue. Shake to go home.";
    }
        ...
        fact.text = @"Although modern images of India often show poverty and lack of development, India was the richest country on earth until the time of British invasion in the early 17th Century.";
                tapToContinue.text = @"Tap to start over. Shake to go home.";
    }
    else {
